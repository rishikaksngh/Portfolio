        ...
        <footer className="border-t border-purple-500/10 py-12 px-4 bg-[#030305]">
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
                <div className="flex flex-col items-center sm:items-start gap-2">
                    <p className="text-sm text-zinc-500 flex items-center gap-1.5 flex-wrap justify-center sm:justify-start">
                    ...
                    {isEditMode && (
                        <span className="text-[10px] text-purple-400/50 uppercase tracking-[0.2em] font-black animate-pulse">
                            Brand Name Editable
                        </span>
                    )}
                </div>
